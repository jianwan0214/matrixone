...
func (Pipeline_PipelineType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{31, 0}
}
...
type ExternalScan struct {
	...
	FileOffset           []int64                  `protobuf:"varint,3,rep,packed,name=file_offset,json=fileOffset,proto3" json:"file_offset,omitempty"`
...
func (m *ExternalScan) GetFileOffset() []int64 {
	if m != nil {
		return m.FileOffset
	}
	return nil
...
type Instruction struct {
	...
	RightSemiJoin        *RightSemiJoin `protobuf:"bytes,28,opt,name=right_semi_join,json=rightSemiJoin,proto3" json:"right_semi_join,omitempty"`
	RightAntiJoin        *RightAntiJoin `protobuf:"bytes,29,opt,name=right_anti_join,json=rightAntiJoin,proto3" json:"right_anti_join,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
type ProcessInfo struct {
	...
	LoadTag              bool               `protobuf:"varint,7,opt,name=load_tag,json=loadTag,proto3" json:"load_tag,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *ProcessInfo) GetLoadTag() bool {
	if m != nil {
		return m.LoadTag
	}
	return false
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
...
func (m *ExternalScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FileOffset) > 0 {
		dAtA62 := make([]byte, len(m.FileOffset)*10)
		var j61 int
		for _, num1 := range m.FileOffset {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.FileSize) > 0 {
		dAtA64 := make([]byte, len(m.FileSize)*10)
		var j63 int
...
func (m *ProcessInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AnalysisNodeList) > 0 {
		dAtA90 := make([]byte, len(m.AnalysisNodeList)*10)
		var j89 int
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.FileOffset = append(m.FileOffset, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.FileOffset) == 0 {
					m.FileOffset = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
